...
class TxliveView extends FrameLayout {
  public TextView textView;
  public SuperPlayerView mSuperPlayerView;

  public TxliveView(Context context) {
    super(context);
    init(context);
  }

  public TxliveView(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context);
  }

  public TxliveView(Context context, AttributeSet attrs, int defStyleAttr) {
